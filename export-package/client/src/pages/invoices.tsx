        ...
        <header className="mb-8">
          ...
          <div className="flex gap-2 mb-6">
            ...
            >
              ...
              جميع الفواتير ({invoices?.length || 0})
            </Button>
            <Button
            ...
            >
              ...
              غير المدفوعة ({invoices?.filter(inv => {
                const paidDate = new Date(inv.paid);
                return paidDate.getFullYear() <= 1900;
              }).length || 0})
            </Button>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-1">
                        تاريخ الفاتورة: {new Date(invoice.date).toLocaleDateString("sv-SE")}
                      </p>
                      <p className="text-sm text-gray-600 mb-1">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-sm text-gray-600">
                          طريقة الدفع: {getPaymentMethodText(invoice.paymode)}
                        </span>
                      </div>
                      {invoice.paid && invoice.paid !== '0000-00-00' && (
                        <p className="text-sm text-green-600 mt-1">
                          تاريخ الدفع: {new Date(invoice.paid).toLocaleDateString("sv-SE")}
                        </p>
                      )}
                      <p className="text-sm text-gray-600 mt-1">
                        مدير الحساب: {invoice.managername}
                      </p>
                    </div>
                    <div className="text-right">
                      <p className={`text-2xl font-bold ${
                        ...
                        {formatPrice(invoice.price)} ليرة سورية
                      </p>
                    </div>
                  </div>
                </CardContent>
