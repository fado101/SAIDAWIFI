...
export class MemStorage implements IStorage {
  ...
  async updateSubscription(id: number, updates: Partial<Subscription>): Promise<Subscription> {
    ...
    const updated: Subscription = {
      ...subscription,
      ...updates,
      activationDate: updates.activationDate ?? subscription.activationDate ?? null,
    };
  ...
  async createUsageRecord(recordData: InsertUsageRecord): Promise<UsageRecord> {
    ...
    const record: UsageRecord = {
      ...
      sessionDuration: recordData.sessionDuration ?? null,
      createdAt: new Date(),
    };
  ...
  async createInvoice(invoiceData: InsertInvoice): Promise<Invoice> {
    ...
    const invoice: Invoice = {
      ...
      confirmedByUserDate: invoiceData.confirmedByUserDate ?? null,
      paidDate: invoiceData.paidDate ?? null,
      verifiedBy: invoiceData.verifiedBy ?? null,
      bankTransferDetails: invoiceData.bankTransferDetails ?? null,
      approvedBy: invoiceData.approvedBy ?? null,
      createdAt: new Date(),
    };
